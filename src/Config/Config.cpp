...
const float feedMotorSpeed = 5000.0;           // Steps per second
const float feedMotorAcceleration = 5000.0;   // Steps per second^2 (increased for smoother acceleration)
...
const float cutMotorAcceleration = 3000.0;    // Steps per second^2 (increased for smooth acceleration)
...
const float cutMotorReturnAcceleration = 3000.0; // Steps per second^2 (gentler acceleration for return)
